...
VARIANT C_Smsgate::Connect(short* WaitTime)
{
	...
	static BYTE parms[] =
		VTS_PI2;
	InvokeHelper(0x60030019, DISPATCH_METHOD, VT_VARIANT, (void*)&result, parms,
		WaitTime);
	return result;
}

CString C_Smsgate::Sendsms(BSTR* Msg, BSTR* Mobile, short* s_Report, BOOL* pV)
{
	CString result;
	static BYTE parms[] =
		VTS_PBSTR VTS_PBSTR VTS_PI2 VTS_PBOOL;
	InvokeHelper(0x6003001b, DISPATCH_METHOD, VT_BSTR, (void*)&result, parms,
		Msg, Mobile, s_Report, pV);
	return result;
}
...
CString C_Smsgate::SendAsc2(VARIANT* AscMsg, VARIANT* tomobile, VARIANT* smsreport)
{
	...
	InvokeHelper(0x6003001d, DISPATCH_METHOD, VT_BSTR, (void*)&result, parms,
...
{
	VARIANT result;
	InvokeHelper(0x6003001f, DISPATCH_METHOD, VT_VARIANT, (void*)&result, NULL);
	return result;
}
...
{
	VARIANT result;
	InvokeHelper(0x60030023, DISPATCH_METHOD, VT_VARIANT, (void*)&result, NULL);
	return result;
}
...
{
	VARIANT result;
	InvokeHelper(0x60030028, DISPATCH_METHOD, VT_VARIANT, (void*)&result, NULL);
	return result;
}
...
{
	VARIANT result;
	InvokeHelper(0x60030029, DISPATCH_METHOD, VT_VARIANT, (void*)&result, NULL);
	return result;
}
...
{
	VARIANT result;
	InvokeHelper(0x6003002a, DISPATCH_METHOD, VT_VARIANT, (void*)&result, NULL);
	return result;
}
...
{
	VARIANT result;
	InvokeHelper(0x68030009, DISPATCH_PROPERTYGET, VT_VARIANT, (void*)&result, NULL);
	return result;
}
...
{
	VARIANT result;
	InvokeHelper(0x6003003e, DISPATCH_METHOD, VT_VARIANT, (void*)&result, NULL);
	return result;
}
...
{
	VARIANT result;
	InvokeHelper(0x6003003f, DISPATCH_METHOD, VT_VARIANT, (void*)&result, NULL);
	return result;
}
...
{
	VARIANT result;
	InvokeHelper(0x60030040, DISPATCH_METHOD, VT_VARIANT, (void*)&result, NULL);
	return result;
}
...
VARIANT C_Smsgate::ReadNB(VARIANT* pb_why)
{
	...
	static BYTE parms[] =
		VTS_PVARIANT;
	InvokeHelper(0x60030042, DISPATCH_METHOD, VT_VARIANT, (void*)&result, parms,
		pb_why);
	return result;
}
...
{
	BOOL result;
	InvokeHelper(0x60030045, DISPATCH_METHOD, VT_BOOL, (void*)&result, NULL);
	return result;
}
...
{
	VARIANT result;
	InvokeHelper(0x60030047, DISPATCH_METHOD, VT_VARIANT, (void*)&result, NULL);
	return result;
}
...
VARIANT C_Smsgate::get_report_all(VARIANT* start_is, VARIANT* strCodeis)
{
	...
	InvokeHelper(0x6003004a, DISPATCH_METHOD, VT_VARIANT, (void*)&result, parms,
		start_is, strCodeis);
	return result;
}
...
{
	VARIANT result;
	InvokeHelper(0x6003004c, DISPATCH_METHOD, VT_VARIANT, (void*)&result, NULL);
	return result;
}
...
{
	VARIANT result;
	InvokeHelper(0x60030050, DISPATCH_METHOD, VT_VARIANT, (void*)&result, NULL);
	return result;
}
...
{
	VARIANT result;
	InvokeHelper(0x60030051, DISPATCH_METHOD, VT_VARIANT, (void*)&result, NULL);
	return result;
}
...
{
	VARIANT result;
	InvokeHelper(0x60030052, DISPATCH_METHOD, VT_VARIANT, (void*)&result, NULL);
	return result;
}
